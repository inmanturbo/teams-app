...
<div x-show="show" x-on:click="show = false" class="absolute top-0 right-0 z-50 flex flex-col items-center mt-4 mr-4 text-sm text-black cursor-pointer modal-close">
    ...
    <div x-show="show" class="h-full mb-6 overflow-hidden transition-all transform bg-white rounded-lg shadow-xl sm:w-full lg:max-w-7xl lg:mx-auto"
