...
class CreateTeam implements CreatesTeams
{
    ...
    public function create($user, array $input)
    {
        ...
        Validator::make($input, [
            'name' => ['required', 'string','unique:' . config('landlord.db_connection') . '.teams,name', 'max:255'],
            'team_database_uuid' => ['required', 'exists:' . config('landlord.db_connection') . '.team_databases,uuid'],
            'uuid' => ['nullable'],
